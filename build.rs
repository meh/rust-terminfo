...
fn main() {
    ...
    write!(
        &mut file,
        "pub static BOOLEAN: ::phf::Map<u16, &'static str> = "
    )
    .unwrap();
    ...
    write!(
        &mut file,
        "pub static BOOLEAN_INDEX: ::phf::Map<&'static str, u16> = "
    )
    .unwrap();
    ...
    write!(
        &mut file,
        "pub static NUMBER: ::phf::Map<u16, &'static str> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::new();
    ...
    write!(
        &mut file,
        "pub static NUMBER_INDEX: ::phf::Map<&'static str, u16> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::<&str>::new();
    for (index, name) in keys.iter().enumerate() {
    ...
    write!(
        &mut file,
        "pub static STRING: ::phf::Map<u16, &'static str> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::new();
    ...
    write!(
        &mut file,
        "pub static STRING_INDEX: ::phf::Map<&'static str, u16> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::<&str>::new();
    for (index, name) in keys.iter().enumerate() {
    ...
    write!(
        &mut file,
        "pub static TERMINFO: ::phf::Map<&'static str, &'static str> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::new();
    ...
    write!(
        &mut file,
        "pub static TERMCAP: ::phf::Map<&'static str, &'static str> = "
    )
    .unwrap();
    let mut builder = phf_codegen::Map::new();
